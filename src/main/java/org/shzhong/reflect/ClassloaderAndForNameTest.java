package org.shzhong.reflect;
 
/**
 * Class.forName和classloader的区别
 * <p>
 * Created by zhongshaohan on 2017/2/21
 */
public class ClassloaderAndForNameTest {
    public static void main(String[] args) {
        String wholeNameLine = "org.shzhong.reflect.Line";
        String wholeNamePoint = "org.shzhong.reflect.Point";
